import asyncio
from src.config import aiohttp, download_image, verify_image_url
from src.generate import extract_product_info_from_images, generate_structured_product_data
